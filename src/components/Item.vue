        ...
        ...mapMutations({
            ...
            setItemEquipeComVerificacao: (commit,payload) => {
                ...
                /**
                 Exemplo
                 reserva do item
                 verificar se o item esta disponivel
                 se sim, marcar no backend que ele esta sendo utilizado para uma equipe
                 se não, apresentar uma msg de controle indicando que o item ja esta em uso
                 */
